/*
 * Created by Jose Fuentes on 25/06/18 23:24
 * Copyright (C) 2018
 *
...
import static com.underlegendz.corelegendz.data.Status.SUCCESS;
...
public class Resource<T> {
  ...
  public static boolean isLoading(Resource resource) {
    return resource != null && LOADING.equals(resource.status);
  }

  public static boolean isError(Resource resource) {
    return resource != null && ERROR.equals(resource.status);
  }

  public static boolean isSuccess(Resource resource) {
    return resource != null && SUCCESS.equals(resource.status);
  }
}